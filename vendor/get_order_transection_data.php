	...
	try {
		...
		while ($stmt->fetch()) {
			...
			if ($col3 == 'Returned Completed') {
				...
				$total_amount =  '-' . round($net_amount, 2) + $reverse_shipping + $gst_on_reverse_shipping;
			}
