...
function getOrderData(pagenov, rownov) {
    ...
    $.ajax({
        ...
        url: 'get_reverse_order_transection_data.php',
        ...
        success: function(response) {
            ...
            if (data["status"] == "1") {
                ...
                $(data["details"]).each(function() {
                    ...
                    $("#tbodyPostid").append('<tr> <td>'+count+'</td><td> ' + this.create_date + '</td><td class="nr">' + this.orderid + '</td><td></td><td>'+this.product_hsn_code+'</td><td>'+this.create_month+'</td><td class="stk" > ' + this.total_qty + '</td> <td>' + this.order_status + '</td><td></td><td>'+this.seller_name+'</td><td>'+this.seller_state+'</td><td>'+this.seller_pincode+'</td><td></td><td>'+this.customer_pincode+'</td><td>'+this.taxable_amount+'</td><td>' + this.gst_amount + '</td><td>'+this.tax_rate+'</td>><td>' + this.total_price + '</td><td>' + this.admin_profit + '</td><td>' + this.total_billing_value + '</td><td>'+this.reverse_shipping+'</td><td>'+this.gst_rete_reverse+'</td><td>'+this.gst_on_reverse_shipping+'</td><td>' + this.total_amount + '</td> </tr> ');
        ...
        success: function(response) {
            ...
            if (data["status"] == "1") {
				...
				$(data["details"]).each(function() {
                    ...
                    $("#tbodyPostid").append('<tr> <td>'+count+'</td><td> ' + this.create_date + '</td><td class="nr">' + this.orderid + '</td><td></td><td>'+this.product_hsn_code+'</td><td>'+this.create_month+'</td><td class="stk" > ' + this.total_qty + '</td> <td>' + this.order_status + '</td><td></td><td>'+this.seller_name+'</td><td>'+this.seller_state+'</td><td>'+this.seller_pincode+'</td><td></td><td>'+this.customer_pincode+'</td><td>'+this.taxable_amount+'</td><td>' + this.gst_amount + '</td><td>'+this.tax_rate+'</td>><td>' + this.total_price + '</td><td>' + this.admin_profit + '</td><td>' + this.total_billing_value + '</td><td>' + this.tds + '</td><td>' + this.tcs + '</td><td>' + this.gst_input + '</td><td>' + this.net_amount + '</td><td>'+this.reverse_shipping+'</td><td>'+this.gst_rete_reverse+'</td><td>'+this.gst_on_reverse_shipping+'</td><td>' + this.total_amount + '</td> </tr> ');
