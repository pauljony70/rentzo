        ...
        success: function (response) {
            ...
            $(data).each(function () {
                ...
                if (this.activate == 'active') {
                    ...
                    html += '<td class="d-flex"> <button type="submit" class= "btn btn-dark waves-effect waves-light btn-sm pull-left" id="editbtn' + this.id + '" name="edit" onclick="editBanners(' + this.id + ',\'' + deactive + '\');">Deactive</button>';
                } else {
                    var active = 'active';
                    html += '<td class="d-flex"> <button type="submit" class= "btn btn-dark waves-effect waves-light btn-sm pull-left" id="editbtn' + this.id + '" name="edit" onclick="editBanners(' + this.id + ',\'' + active + '\');">Active</button>';
                }
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            $(data).each(function () {
                ...
                html += '<td  class="d-flex"> <button type="submit" class= "btn btn-dark waves-effect waves-light btn-sm pull-left" id="editbtn' + this.id + '" name="edit" onclick="editBanners(' + this.id + ', ' + this.cat_order + ', ' + total_records + ');">Deactive</button>';
                html += '<button style=" margin-left: 10px;" type="submit" class= "btn btn-danger waves-effect waves-light btn-sm pull-left" name="delete"  id="deletebtn' + this.id + '" onclick="deleteBanners(' + this.id + ');">DELETE</button>';
