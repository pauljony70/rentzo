...
$regionid=   stripslashes($regionid);
...
if($code == $_SESSION['_token'] && !empty($regionid)){
    ...
    try{
        ...
        // echo "class id is  ".$class_id;     
           $stmt = $conn->prepare("SELECT id, name FROM governorates WHERE region_id=? ORDER BY name ASC");
