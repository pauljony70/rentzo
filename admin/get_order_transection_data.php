    ...
    try{
	   ...
	   $stmt ->bind_param("ii", $start, $limit);
    	   ...
    	   $stmt->execute();	 
     	   ...
     	   $data = $stmt->bind_result( $col1, $col2, $col3, $col4, $col5, $col6, $col7, $col8, $col9, $col10, $col11 ,$seller_price,$admin_profit,$tds,$tcs,$gross_amount,$gst_input,$net_amount,$product_hsn_code,$seller_name,$seller_state,$seller_pincode,$taxable_amount,$tax_rate,$prod_price);
          ...
          //echo " get col data ";
    	   ...
    	   while ($stmt->fetch()) {    
				...
				$gst_input = round($admin_profit * 18/100,2);
        	   	$return[$i] = 
        					...
        					array(	
        						...
        						'orderid' => $col1,
        						 ...
        						 'payment_orderid' => $col5,
              		  			 ...
              		  			 'total_billing_value' => round($gst_input + round($admin_profit,2),2)
            ...
            $stmt12 = $conn->prepare("SELECT count(*) FROM orders o,order_product op WHERE op.order_id = o.order_id  ".$order_id_qry." ".$order_status_qry." ".$order_date_qry." and op.vendor_id='".$seller_id."' group by op.prod_id");
