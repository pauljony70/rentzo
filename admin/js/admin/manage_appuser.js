        ...
        success: function (response) {
            ...
            if (data["status"] == "1") {
                ...
                $(data["details"]).each(function () {
                    ...
                    $("#tbodyPostid").append('<tr> <td class="nr">' + this.user_unique_id + '</td><td>' + this.fullname + '</td>  <td class="stk" > ' + this.phone + '</td><td>' + this.email + '</td><td> ' + this.createby + '</td><td>' + btnactive + '</td></tr> ');
