        ...
        success: function (response) {
            ...
            if (data["status"] == "1") {
                ...
                $(data["details"]).each(function () {
                    ...
                    public_html = '<tr> <td>' + count + '</td><td> ' + this.order_id + '</td><td class="nr">' + this.product_id + '</td><td>' + this.total_msg + '</td> <td><div class="d-flex"><button type="submit"  class= "btn btn-danger waves-effect waves-light btn-sm pull-left open-modal" target="_blank" data-order_id="' + this.order_id + '" data-id="' + this.id + '" data-toggle="modal" data-target="#myModal">View Message</button></div></td></tr> ';
