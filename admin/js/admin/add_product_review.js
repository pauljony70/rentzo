    ...
    $("#moreImg").click(function () {
        ...
        if (showId <= high) {
            $(".input-files").append('<div id="more_img' + showId + '"><br><input type="file" id="prod_img' + showId + '"  onchange=uploadFile1("prod_img' + showId + '")  name="product_image[]" style="float:left; display: inline-block; margin-right:20px;"> </input> ' +
                '<a class="btn btn-sm btn-danger waves-effect waves-light" onclick=removeImage("more_img' + showId + '"); return false;" style="float:left; display: inline-block; margin-right:20px;">Remove</a> <br></div>');
        }
    });
        ...
        success: function (response) {
            ...
            if (data["status"] == "1") {
                $(data["data"]).each(function () {
                    ...
                    var o = new Option(this.fullname, this.id);
                    $("#selectuser").append(o);
                });
