...
function getOrderData(pagenov, rownov) {
    ...
    $.ajax({
        ...
        url: 'get_security_payment_transection_data.php',
        ...
        success: function (response) {
            ...
            if (data["status"] == "1") {
                ...
                $(data["details"]).each(function () {
                    ...
                    public_html = '<tr> <td>' + count + '</td><td> ' + this.companyname + '</td><td class="nr">' + this.amount + '</td><td>' + this.payment_status + '</td> <td>' + this.transection_id + '</td><td><div class="d-flex">';
