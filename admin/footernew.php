<!--footer-->
<div class="footer">
	<p class="text-center mb-0">&copy; <?php echo date('Y'); ?> <?php echo $Common_Function->get_system_settings($conn, 'system_name'); ?>. All Rights Reserved | Design and developed by <a href="https://www.blueappsoftware.com/" class="text-dark" target="_blank">BlueApp Software</a></p>
</div>
<!--//footer-->
</div>
