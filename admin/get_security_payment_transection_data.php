  ...
  header("Location: index.php");
    ...
    try{
		...
		//echo "SELECT o.order_id,o.user_id,o.status, o.total_price, o.payment_orderid,o.payment_id,o.payment_mode,o.qoute_id,o.create_date,
          ...
          $stmt = $conn->prepare("SELECT pm.id,pm.user_id,pm.amount,pm.payment_status,pm.transection_id,sl.fullname FROM security_payment pm,appuser_login sl WHERE sl.user_unique_id = pm.user_id   ".$order_status_qry." ORDER BY pm.id ASC LIMIT ?, ?");
	   ...
	   $stmt ->bind_param("ii", $start, $limit);
    	   ...
    	   $stmt->execute();	 
     	   ...
     	   $data = $stmt->bind_result( $id,$user_id, $amount, $status, $transection_id,$companyname);
