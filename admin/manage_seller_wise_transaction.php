...
<input type="hidden" name="seller_id" id="seller_id" value="<?php echo $_REQUEST['id']; ?>">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-12 mb-2">
                                        <div class="float-md-right">
                                            <button id="excel_export" class="btn btn-success waves-effect waves-light">Excel</button>
                                            <button id="pdf_export" class="btn btn-warning waves-effect waves-light">PDF</button>
                                        </div>
                                    </div>
                                </div>
...
<script src="js/admin/manage_seller_orders_transection.js"></script>