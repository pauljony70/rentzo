			...
			<div class="row">
				<div class="col-12">
					<div class="page-title-box">
						<h4 class="page-title">All HSN Code</h4>
					</div>
				</div>
			</div>
							...
							<div data-example-id="simple-form-inline">
								...
								<div class="row align-items-center">
									<div class="col-md-6 mb-2">
										<button type="button" class="btn btn-danger waves-effect waves-light" id="" data-toggle="modal" data-target="#myModal">Add HSN Code</button>
									</div>
									<div class="col-md-6 mb-2">
...
<script src="js/admin/manage_hsncode.js"></script>
<!--//footer-->
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form class="form" id="add_attributes_form" enctype="multipart/form-data">
					...
					<button type="submit" class="btn btn-dark waves-effect waves-light" value="Upload" href="javascript:void(0)" id="add_hsncode_btn">Add</button>
			...
			<div class="modal-body">
				...
				<form class="form" id="update_attributes_form" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="update_hsn_code" placeholder="HSN Code">
					...
					<input type="hidden" class="form-control" id="hsn_id">

					<button type="submit" class="btn btn-dark waves-effect waves-light" value="Upload" href="javascript:void(0)" id="update_hsncode_btn">Update </button>
