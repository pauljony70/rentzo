      ...
      <div class="row">
        <div class="col-12">
          <div class="page-title-box">
            <h4 class="page-title">Ticket Replay (<?php echo $_REQUEST['id']; ?>)</h4>
          </div>
        </div>
      </div>
		<input type="hidden" id="ticket_id" value="<?php echo $_REQUEST['id']; ?>">
      <div class="row">
        <div class="col-12">
          <div class="card">
            <div class="card-body">
              <div data-example-id="simple-form-inline">
                <div class="row align-items-center">
                  <div class="col-md-6 mb-2">
                    <button type="button" class="btn btn-danger waves-effect waves-light" id="" data-toggle="modal" data-target="#myModal">Add Ticket Replay</button>
                  </div>
                  <div class="col-md-6 mb-2">
...
<script src="js/admin/manage_ticket_replay.js"></script>
<!--//footer-->
