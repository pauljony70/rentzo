              ...
              <div data-example-id="simple-form-inline">
                ...
                <div class="row align-items-center">
                  ...
                  <div class="col-md-6 mb-2">
                    ...
                    <button type="button" class="btn btn-danger waves-effect waves-light" id="" onclick="redirect_page('notification.php')">Add Notification</button>
...
<script src="js/admin/notification_list.js"></script>
