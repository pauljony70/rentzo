								...
								<div class="row align-items-center">
									<div class="col-md-9 mb-2">
										<div class="d-flex flex-wrap">
											...
											<select class="form-control mr-1" id="selectgroup" name="selectgroup" onchange="groupfilter()" style="display:none; width:180px;" required="">
...
<!--//footer-->
<script src="js/admin/manage_seller_transaction.js"></script>