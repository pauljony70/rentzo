...
$query = $conn->query("SELECT stateid FROM `state` WHERE stateid ='" . trim($_REQUEST['id']) . "'");
if ($query->num_rows > 0) {
      ...
      <div class="row">
        <div class="col-12">
          <div class="page-title-box">
            <h4 class="page-title">All City</h4>
          </div>
        </div>
      </div>
      <div class="row">
              ...
              <div data-example-id="simple-form-inline">
                <div class="row align-items-center">
                  <div class="col-md-6 mb-2">
                    <button type="button" class="btn btn-danger waves-effect waves-light" id="" data-toggle="modal" data-target="#myModal">Add City</button>
                  </div>
                  <div class="col-md-6 mb-2">
...
<script src="js/admin/manage_city.js"></script>
<!--//footer-->
