								...
								<div class="form-three widget-shadow">
									<form class="form-horizontal" id="myform" action="add_product_process.php" method="post" enctype="multipart/form-data">
													...
													<div class="panel-body">
														...
														<!-- <div class="panel panel-default" id="customer-price-breakdown">
															<div class="panel-body row" style="display: flex; align-items: center; height: 100%">
																...
																<div class="col-md-8">
																	<p class="text-muted" style="font-size: 12px;">Marurang Price  OMR 8999</p>
																	<p class="text-muted" style="font-size: 12px;">Shipping (added separately)  OMR 136</p>
																	<h5> OMR 9135</h5>
																</div>
															</div>
														</div> -->
										...
										<div class="form-group row align-items-center d-none">
											...
											<div class="col-sm-8">
												<input type="text" class="form-control" id="affiliate_commission" name="affiliate_commission" placeholder="Affiliate Commission">
											</div>
										</div>
										<div class="form-group row align-items-center">
											<label for="focusedinput" class="col-sm-2 control-label m-0">Quantity <span class="text-danger">&#42;&#42;</span></label>
											<div class="col-sm-8">
										...
										<!--<div class="form-group row align-items-center">
        									<label for="focusedinput" class="col-sm-2 control-label m-0">Arabic Meta Title</label>
        									<div class="col-sm-8">
        										<input type="text" class="form-control" id="prod_meta_ar" name="prod_meta_ar" placeholder="60 Letters">
        									</div>
        								</div>
        								<div class="form-group row align-items-center">
        									<label for="focusedinput" class="col-sm-2 control-label m-0">Arabic Meta Keywords</label>
        									<div class="col-sm-8">
        										<input type="text" class="form-control" id="prod_keyword_ar" name="prod_keyword_ar"   placeholder="250 letters">
        									</div>
        								</div>
        								<div class="form-group row align-items-center">
        									<label for="focusedinput" class="col-sm-2 control-label m-0">Arabic Meta Description</label>
        									<div class="col-sm-8">
        										<textarea  class="form-control" rows="7" id="prod_meta_desc_ar" name="prod_meta_desc_ar"  placeholder="150 letters"></textarea>
        									</div>
        								</div>-->
										</br></br>
		...
		timeout = setTimeout(function() {
			$.ajax({
				...
				if (seller_price.value === '') {
					...
					var commision_fee_value = parseFloat(response.replace(/,/g, '')) - parseFloat(seller_price.value);
					var taxableValue = 0;
