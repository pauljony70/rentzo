						...
						<div class="card-body">
							...
							<section>
								<div class="container">
									<div class="row">
										<div class="col-md-12">
											<h3 style="text-align:center;"> Offers for you </h3><br>
										</div>
										<?php
										//sql for top banner
										$query37 = $conn->query("SELECT pp.id, pd.prod_name, pd.featured_img FROM product_details pd,popular_product pp WHERE pd.status IN(1) AND pp.product_id= pd.product_unique_id  AND pp.type = 'home_bottom'");


										?>
										<?php if ($query37->num_rows <= 8) { ?>
											<div class="col-md-12 ">
												<button type="button" class="btn btn-danger waves-effect waves-light mb-2" onclick="add_banner_section7('home_bottom');">Add Products</button></h4>
											</div>
										<?php } ?>
...
<script src="js/admin/homepage-web.js"></script>