      ...
      <div class="row">
        <div class="col-12">
          <div class="page-title-box">
            <h4 class="page-title">All Days Price</h4>
          </div>
        </div>
      </div>
              ...
              <div data-example-id="simple-form-inline">
                <div class="row align-items-center">
                  <div class="col-md-6 mb-2">
                    <button type="button" class="btn btn-danger waves-effect waves-light" id="" data-toggle="modal" data-target="#myModal">Add Days Price</button>
                  </div>
                  <div class="col-md-6 mb-2">
...
<script src="js/admin/manage_days_price.js"></script>
<!--//footer-->
  ...
  <div class="modal-dialog  modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Add Days Price</h5>
      ...
      <div class="modal-body">
        <form class="form" id="add_tax_form" enctype="multipart/form-data">
          ...
          <button type="submit" class="btn btn-dark waves-effect waves-light" value="Upload" href="javascript:void(0)" id="add_days_btn">Add</button>
        </form>
      </div>
...
<div class="modal fade" id="myModalupdate" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
  <div class="modal-dialog  modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Edit Days price</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form class="form" id="update_tax_form" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <label for="name">Days</label>
            <input type="text" class="form-control" id="update_days" placeholder="Days">
          </div>
          <div class="form-group">
            <label for="name">Price</label>
            <input type="number" class="form-control" id="update_price" placeholder="Price">
          </div>
          <div class="form-group">
          ...
          <input type="hidden" class="form-control" id="days_id">
