...
if ($code == $_SESSION['_token']) {
    try {
        ...
        if ($_POST['selectattrs'] && $_POST['product_name']) {
            echo '<table class="table table-bordered table-centered mt-1"><thead class="thead-light"> <tr> <th>Product Name</th><th>Product SKU</th><th>Sale Price</th>  <th>MRP </th>  <th>STOCK </th><th>Image </th><th>Remove </th>  </tr></thead><tbody>';
            $html = '';
