...
<body>
	...
	<?php if (empty($order_details['order_summary'])) { ?>
		<main class="empty-order mt-0">
			<section class="my-5">
				<div class="container">
					<div class="d-flex flex-column align-items-center empty-cart-image">
						...
						<div class="heading mb-2">No Order Found</div>
						<div class="des mb-4">Looks like you have navigated to the incorrect URL</div>
					...
					<div class="row order-details mb-4">
						...
						<div class="col-md-5">
							...
							<div class="seller-address">
								<div class="div-heading mb-3">Seller Address</div>
