<div id="MyProfile" class="d-lg-none">
	...
	<div id="collapse1" class="accordion-collapse <?php if ($_SERVER['REQUEST_URI'] == '/personal_info') echo "show";
													else echo "collapse"; ?>" aria-labelledby="heading1" data-bs-parent="#MyProfile">
			...
			<div class="wrap box-shadow-4">
				<div class="wrap-block">
					...
					<div class="wrap-details">
						...
						<h6><a href="<?php echo base_url; ?>buy-from-turkey-orders"><?= $this->lang->line('user-buy-from-turkey-orders'); ?></a></h6>
				...
				<div class="wrap-block">
					...
					<div class="wrap-details">
						...
						<h6><a href="<?php echo base_url; ?>bank-details"><?= $this->lang->line('manage-bank-account') ?></a></h6>
					</div>
				</div>
				<hr />
				<div class="wrap-block">
