...
<!--
    ...
    ---------------------------------------------------
-->
<div class="modal fade" id="pincodeModal" <?= $this->session->userdata("address") ? '' : 'data-bs-backdrop="static"' ?> data-bs-keyboard="false" tabindex="-1" aria-labelledby="pincodeModalLabel" aria-hidden="true">
