...
<body>
    ...
    <main>
        ...
        <section class="pt-md-2 pt-2 mt-3 top-category">
            <div class="container">
                <div class="col-12">
                    <h5 class="mb-md-4" style="font-size:13px;"><?php echo $events[0]->name; ?></h5>
                </div>
				<div class="row banners mb-3">
					<img src="<?php echo $events[0]->event_image; ?>" class="mb-1" alt="" >
				</div>
                <div class="row">
				   <?php foreach ($category as $maincat1) { ?>
                            ...
                            <?php if ($maincat1['cat_id'] == 10) { ?>
                                ...
                                <?php } else { ?>
                                    ...
                                    <div class="card position-relative" style="border: 0.5px solid #ccc;">
                                        <img src="<?php echo $maincat1['web_banner']; ?>" alt="" class="img-fluid">
