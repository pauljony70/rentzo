...
class Wishlist extends REST_Controller {
	...
	public function wishlist_list_get()
	{	
		$qoute_id = $this->session->userdata("qoute_id");
		$user_id = $this->session->userdata("user_id");
		$default_language = $this->session->userdata("default_language");
		$this->data['wishlist'] = $this->wishlist_model->get_cart_full_details($default_language,$user_id,2);
		$this->load->view('website/wishlist.php',$this->data);  // ye view/website folder hai
