...
$route['add_ticket_replay_form'] = 'Home/add_ticket_replay_form';
...
$route['ticket/(:any)'] = 'Home/ticket/$1';
...
$route['nearby-products'] = 'Home/get_nearby_products';
$route['get_home_arival_banner'] = 'Home/get_home_arival_banner';
$route['get_home_events'] = 'Home/get_home_events';
