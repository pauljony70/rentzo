...
function zoom(t, e, n) {
  ...
  for (
    ...
    (m = _[ot]),
      (b = m.children[0]).setAttribute(J, 1),
      b.setAttribute(K, 0),
      b.setAttribute(Q, 0);
  function at(t, e) {
  ...
  window.addEventListener("load", function () {
    ...
    ct(_, "mousedown", function (t) {
      ...
      if (
        ...
        et[0] === t.target &&
        nt <= 5 &&
        !0 === ut(y, et[1] - 10, et[1] + 10) &&
        !0 === ut(Y, et[2] - 10, et[2] + 10)
      )
        return (
          at(b, U),
          !0 === lt(m, I)
    ...
    ct(_, "mouseenter", function () {
      !(function () {
        ...
        window.addEventListener("DOMMouseScroll", ft, !1),
          window.addEventListener(f, ft, h),
    ...
    ct(_, "mouseleave", function () {
      !(function () {
        ...
        window.removeEventListener("DOMMouseScroll", ft, !1),
          window.removeEventListener(f, ft, h),
    ...
    ct(_, "touchstart", function (t) {
      ...
      if (
        ...
        if (null === st[0])
          ...
          st[0] === t.target &&
          rt <= 1 &&
          !0 === ut(y, st[1] - 10, st[1] + 10) &&
          !0 === ut(Y, st[2] - 10, st[2] + 10)
        )
          return (
            at(b, U),
            !0 === lt(m, I)
            ...
            ? ((S = t.touches[1].clientX),
              ...
              Math.abs(F - q) >= 1 &&
                ...
                (B =
                  E * V <= v
                    ? 0
                    : dt(L - ((O - A - v / 2 - L) / (V - T)) * T, -1 * D, D)),
                (j =
                  x * V <= g
                    ? 0
                    : dt(M - ((W - p - g / 2 - M) / (V - T)) * T, -1 * k, k)),
                V > 1 ? vt(m) : At(m),
                ht(b, B + "px", j + "px", V),
                (F = q),
                (w = V),
    ...
    document.addEventListener("touchend", function (t) {
      ...
      0 === G
        ? (b.setAttribute(J, w),
          ...
          (tt = !1))
        : 1 === G
        ? ((y = t.touches[0].clientX), (Y = t.touches[0].clientY))
        : G > 1 && (F = null);
    }),
