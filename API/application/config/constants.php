...
defined('LIMIT')      OR define('LIMIT', 10); // Result limit
defined('MOBILE')      OR define('MOBILE', '430-590'); // image size for mobile
defined('MOBILE_CATBANNER')      OR define('MOBILE_CATBANNER', '400-200'); // image size for mobile
...
defined('ORDER_RECEIVED_NOTIFICATION_TEMP') OR define('ORDER_RECEIVED_NOTIFICATION_TEMP', 5); // place order email template id
